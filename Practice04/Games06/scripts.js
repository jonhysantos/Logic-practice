...
function currencyFormat(value){
    const formatBr = value.toLocaleString('pt-BR',{style:'currency',currency:'BRL'})
    return formatBr
}
...
function sumAll(){
    ...
    list.innerHTML = `O total de todos os itens com 57% de desconto ${currencyFormat(total * 0.43)}` 
}
